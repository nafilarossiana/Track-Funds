...
class MechanicalModel extends Model
{
    protected $table = 'mechanical';
    protected $returnType = 'array';
    protected $primaryKey = 'id_mechanical';

    protected $useTimestamps = false;
    protected $allowedFields = ['id_mechanical','tahun','unit','gl_account','jenis','jeniskontrak','status','no','detail_program','rka','geser','nilai_pekerjaan',
    ...
    public function getPages($id_mechanical){

        return $this->find($id_mechanical);
    }
    public function getAirsideDataById($id_mechanical)
    {
        return $this->find($id_mechanical);
    }
...
public function getUniqueAccount()
{
    ...
    {
        $select = $this->db->table('mechanical')
