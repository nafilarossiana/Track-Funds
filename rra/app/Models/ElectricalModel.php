...
class ElectricalModel extends Model
{
    protected $table = 'electrical';
    protected $returnType = 'array';
    protected $primaryKey = 'id_electrical';

    protected $useTimestamps = false;
    protected $allowedFields = ['id_electrical','tahun','unit','gl_account','jenis','jeniskontrak','status','no','detail_program','rka','geser','nilai_pekerjaan',
    ...
    public function getPages($id_electrical){

        return $this->find($id_electrical);
    }
    public function getElectricalDataById($id_electrical)
    {
        return $this->find($id_electrical);
    }
...
public function getUniqueAccount()
{
    ...
    {
        $select = $this->db->table('electrical')
