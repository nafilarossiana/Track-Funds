...
<div class="center">
    ...
    <h4 style="margin-bottom: 5px; margin-top:15px; font-weight: 700;">Data Unit Airport Technology Facilties</h4>
    <div class="button-data">
                <button type="button" class="btn custom-button" onclick="redirectToPage('/pages/airporttech/dashairporttech')">
        ...
        <div class="content-table">
            <ul class="nav nav-tabs" id="airporttech-table" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="airporttech-main-tab" data-toggle="tab" href="#airporttech-main" role="tab">
                     Data Main Airport Tech 
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="airporttech-month-tab" data-toggle="tab" href="#airporttech-month" role="tab">
                       Data Month Aiport Tech
                    </a>    
        </li>
            ...
            <div class="tab-content">
                <!--- Tabel Rekap -->
                <div class="tab-pane fade" id="airporttech-rekap" role="tabpanel">
                ...
                <!--- Tabel List Akun -->
            <div class="tab-pane fade" id="airporttech-akun" role="tabpanel">
                <div class="table-responsive">
                    <br>
                ...
                <!-- Data Main--> 
                <div class="tab-pane fade show active" id="airporttech-main" role="tabpanel">
                <div class="table-responsive">
                    <br>
                    <!-- Dropdown Tahun-->
                    <br>
                    <form action="/pages/airporttech/airporttech" method="post">
   <!-- Dropdown Tahun -->
<div class="body-year">
...
<div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item has-icon" href="<?=site_url('pages/elecetrical/excelairporttech')?>">
                    <i class="fas fa-file-import"></i> &nbsp; Export Excel</a>
            </div>
        </div>
        &nbsp; &nbsp;
        <div class="button-add">
            <button type="button" class="btn custom-button" onclick="redirectToPage('/pages/airporttech/addairporttech')">
                <i class="fa fa-plus"></i>&nbsp; &nbsp; Add
                    ...
                    <table id="tabelmain" class="table table-striped" style="width:100%">
                        ...
                        <td><?= $rc['keterangan']; ?></td>
                        <td>
                                <a href="/pages/editairporttech/<?=$rc['id_airporttech']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                <form action="/pages/airporttech/<?= $rc['id_airporttech']; ?>" method="post" class="d-inline">
                                <?= csrf_field(); ?>
              ...
              <!-- Data Month -->
    <div class="tab-pane fade" id="airporttech-month" role="tabpanel">
    <div class="table-responsive">
        <br>
        <br>
