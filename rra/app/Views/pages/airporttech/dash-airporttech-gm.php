    ...
    <div class="content-1">
        <div class="header-text">
            <div class="section-header">
                <h4 style="margin-bottom: 5px;">Dashboard Airport Technology Facilities</h4>
                <div class="button-data" style="position: absolute; top: 0; right: 0; margin: 10px;">
                <div class="alert alert-success p-1" role="alert">
        <select name="q" id="satker" class="form-control form-control-sm selectpicker" data-live-search="true" onchange="navigateToPage()">
        <option value="/pages/airporttech/dashairporttechgm">Airport Technology</option>
            <option value="/pages/dashairsidegm">Airside Facilities</option>
            <option value="/landside/dashlandsidegm">Landside Facilities</option>
            <option value="/pages/mechanical/dashmechanicalgm">Equipment-Mechanical</option>
            <option value="/pages/electrical/dashelectricalgm">Equipment-Electrical</option>
        </select>
    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered" style="width:100%;">
                        <thead class="theadrekap">
                            ...
                            <tr>
                                <th class="text-center" colspan="9">Airport Technology Department</th>
                            </tr>
                            <tr class="trRekap">
...
function navigateToPage() {
    const selectElement = document.getElementById('satker');
