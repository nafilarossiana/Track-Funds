...
<style>
    ...
    .form-control {
        border: 1px solid #ced4da; /* Tambahkan border di sini */
        border-radius: 0.25rem; /* Border radius untuk tampilan lebih bagus */
    }
    .section-header{
...
<div class="center">
    ...
    <h4 style="margin-bottom: 5px;">Add Data Airport Technology Facilities  </h4>
    <p style="margin-top: 5px;">Masukkan Data Detail Program dan Anggaran dengan benar </p>
    </div>
      <div class="header-form">
     <button type="button" class="btn custom-button" onclick="redirectAirportTechPage()">
     <i class="fa fa-arrow-left"></i>&nbsp; &nbsp; Kembali
     </button>
      <br>
      <form action="/pages/airporttech/saveairporttech" method="post">
      <?= csrf_field(); ?>
        <div class="card-body">
          <div class="row">
            <!--kolom 1-->
...
<script>
    function redirectToAirportTechsidePage() {
        window.location.href = '/airporttech/airporttech#airporttech-month';
    }
</script>
<script>
