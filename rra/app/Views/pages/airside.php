...
<style>
   ...
   .center .content-2 {
    ...
    th, td {
    padding: 15px 15landpx !important; 
...
<div class="center">
    ...
    <h4 style="margin-bottom: 5px; margin-top:15px; font-weight: 700;">Data Unit Airside Facilties</h4>
    <div class="button-data">
                <button type="button" class="btn custom-button" onclick="redirectToPage('/pages/dashairside')">
        ...
        <div class="content-table">
            <ul class="nav nav-tabs" id="airside-table" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="airside-main-tab" data-toggle="tab" href="#airside-main" role="tab">
                     Data Main Airside 
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="airside-month-tab" data-toggle="tab" href="#airside-month" role="tab">
                       Data Month Aiside
                    </a>    
        </li>
            ...
            <div class="tab-content">
                <!--- Tabel Rekap -->
                <div class="tab-pane fade" id="airside-rekap" role="tabpanel">
                ...
                <!--- Tabel List Akun --> 
            <div class="tab-pane fade" id="airside-akun" role="tabpanel">
                <div class="table-responsive">
                    <br>
                ...
                <!-- Data Main--> 
                <div class="tab-pane fade show active" id="airside-main" role="tabpanel">
                <div class="table-responsive">
                    <br>
                    <!-- Dropdown Tahun-->
                   
                    <form action="/pages/airside" method="post">
   <!-- Dropdown Tahun -->
...
<div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item has-icon" href="<?=site_url('pages/exportExcel')?>">
                    <i class="fas fa-file-import"></i> &nbsp; Export Excel</a>
            </div>
        </div>
        &nbsp; &nbsp;
        <div class="button-add">
            <button type="button" class="btn custom-button" onclick="redirectToPage('/pages/addairside')">
                <i class="fa fa-plus"></i>&nbsp; &nbsp; Add
                    ...
                    <table id="tabelmain" class="table table-striped" style="width:100%">
                        ...
                        <td><?= $rc['keterangan']; ?></td>
                        <td>
                                <a href="/pages/editairside/<?=$rc['id_airside']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                <form action="/pages/<?= $rc['id_airside']; ?>" method="post" class="d-inline">
                                <?= csrf_field(); ?>
              ...
              <!-- Data Month -->
    <div class="tab-pane fade" id="airside-month" role="tabpanel">
    <div class="table-responsive">
        <br>
        <br>
