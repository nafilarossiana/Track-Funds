...
<div class="center">
    ...
    <h4 style="margin-bottom: 5px; margin-top:15px; font-weight: 700;">Data Unit Landside Facilties</h4>
    <!-- Tombol Chart -->
    <div class="button-data">
                <button type="button" class="btn custom-button" onclick="redirectToPage('/landside/dashlandside')">
        ...
        <div class="content-table">
            <ul class="nav nav-tabs" id="landside-table" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="landside-main-tab" data-toggle="tab" href="#landside-main" role="tab">
                     Data Main Landside 
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="landside-month-tab" data-toggle="tab" href="#landside-month" role="tab">
                       Data Month Landside
                    </a>    
        </li>
            </ul>
            ...
            <div class="tab-content">
                <!--- Tabel Rekap -->
                <div class="tab-pane fade" id="landside-rekap" role="tabpanel">
                ...
                <!--- Tabel List Akun --> 
            <div class="tab-pane fade" id="landside-akun" role="tabpanel">
                <div class="table-responsive">
                    <br>
                ...
                <!-- Data Main--> 
                <div class="tab-pane fade show active" id="landside-main" role="tabpanel">
                <div class="table-responsive">
                    <br>
                    <!-- Dropdown Tahun-->

                    <form action="/landside/landside" method="post">
   <!-- Dropdown Tahun -->
<!-- Dropdown GL Account -->
...
<div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item has-icon" href="<?=site_url('landside/exportexcellandside')?>">
                    <i class="fas fa-file-import"></i> &nbsp; Export Excel</a>
            </div>
        </div>
        &nbsp; &nbsp;
        <div class="button-add">
            <button type="button" class="btn custom-button" onclick="redirectToPage('/landside/addlandside')">
                <i class="fa fa-plus"></i>&nbsp; &nbsp; Add
                    ...
                    <table id="tabelmain" class="table table-striped" style="width:100%">
                        ...
                        <td><?= $rc['keterangan']; ?></td>
                        <td>
                                <a href="/landside/editlandside/<?=$rc['id_landside']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                <form action="/landside/<?= $rc['id_landside']; ?>" method="post" class="d-inline">
                                <?= csrf_field(); ?>
              ...
              <!-- Data Month -->
    <div class="tab-pane fade" id="landside-month" role="tabpanel">
    <div class="table-responsive">
        <br>
        <br>
