...
<div class="center">
    ...
    <h4 style="margin-bottom: 5px;">Add Data Electrical Facilities  </h4>
    <p style="margin-top: 5px;">Masukkan Data Detail Program dan Anggaran dengan benar </p>
    </div>
      <div class="header-form">
     <button type="button" class="btn custom-button" onclick="redirectElectricalaPage()">
     <i class="fa fa-arrow-left"></i>&nbsp; &nbsp; Kembali
     </button>
      <br>
      <form action="/pages/electrical/saveelectrical" method="post">
      <?= csrf_field(); ?>
        <div class="card-body">
          <div class="row">
            <!--kolom 1-->
...
<script>
    function redirectToElectricalsidePage() {
