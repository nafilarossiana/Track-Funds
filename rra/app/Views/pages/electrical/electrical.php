...
<div class="center">
    ...
    <h4 style="margin-bottom: 5px; margin-top:15px; font-weight: 700;">Data Unit Electrical Facilties</h4>
    <div class="button-data">
                <button type="button" class="btn custom-button" onclick="redirectToPage('/pages/electrical/dashelectrical')">
        ...
        <div class="content-table">
            <ul class="nav nav-tabs" id="electrical-table" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="electrical-main-tab" data-toggle="tab" href="#electrical-main" role="tab">
                     Data Main Electrical 
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="electrical-month-tab" data-toggle="tab" href="#electrical-month" role="tab">
                       Data Month Electrical
                    </a>    
        </li>
            ...
            <div class="tab-content">
                <!--- Tabel Rekap -->
                <div class="tab-pane fade" id="electrical-rekap" role="tabpanel">
                ...
                <!--- Tabel List Akun -->
            <div class="tab-pane fade" id="electrical-akun" role="tabpanel">
                <div class="table-responsive">
                    <br>
                ...
                <!-- Data Main--> 
                <div class="tab-pane fade show active" id="electrical-main" role="tabpanel">
                <div class="table-responsive">
                    <br>
                    <!-- Dropdown Tahun-->
                    <br>
                    <form action="/pages/electrical/electrical" method="post">
   <!-- Dropdown Tahun -->
<div class="body-year">
...
<div class="btn-group">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item has-icon" href="<?=site_url('pages/elecetrical/excelelectrical')?>">
                    <i class="fas fa-file-import"></i> &nbsp; Export Excel</a>
            </div>
        </div>
        &nbsp; &nbsp;
        <div class="button-add">
            <button type="button" class="btn custom-button" onclick="redirectToPage('/pages/electrical/addelectrical')">
                <i class="fa fa-plus"></i>&nbsp; &nbsp; Add
                    ...
                    <table id="tabelmain" class="table table-striped" style="width:100%">
                        ...
                        <td><?= $rc['keterangan']; ?></td>
                        <td>
                                <a href="/pages/editelectrical/<?=$rc['id_electrical']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                <form action="/pages/electrical/<?= $rc['id_electrical']; ?>" method="post" class="d-inline">
                                <?= csrf_field(); ?>
              ...
              <!-- Data Month -->
    <div class="tab-pane fade" id="electrical-month" role="tabpanel">
    <div class="table-responsive">
        <br>
        <br>
