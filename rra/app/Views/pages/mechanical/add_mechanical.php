...
<div class="center">
    ...
    <h4 style="margin-bottom: 5px;">Add Data Mechanical Facilities  </h4>
    <p style="margin-top: 5px;">Masukkan Data Detail Program dan Anggaran dengan benar </p>
     ...
     <i class="fa fa-arrow-left"></i>&nbsp; &nbsp; Kembali
      ...
      <br>
      <form action="/pages/mechanical/savemechanical" method="post">
      <?= csrf_field(); ?>
        <div class="card-body">
          <div class="row">
            <!--kolom 1-->
...
<script>
    function redirectToMechanicalsidePage() {
