    ...
    <div class="wrapper">
        <section>
            <div class="form-value">
                ...
                <form method ="POST" action="<?=site_url('pages/saveuser') ?>" >
                <?=csrf_field()?>
                    <img class="logoap" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBq8VspFncmi6Esy-dXC-AsBEAKyPWMMlY3AW2gPkzYw&s">
                    <h3><span class="text-biru">Angkasa Pura</span> <span class="text-hijau">| Airports</span></h3>
                    <br>
                ...
                <?php endif; ?>
                    ...
                    <div class="inputbox password">
                        ...
                        <input type="text" id="password" class="form-control" name="password" tabindex="1" placeholder="Password" autocomplete="off" required>
                    </div>
